    ...
    <div>
      ...
      >
        <div className="stat-card">
          ...
          <div style={{ fontSize: 18, fontWeight: 700, marginTop: 4 }}>1.0.0</div>
        ...
        <div className="stat-card">
          ...
          <div style={{ marginTop: 8, display: 'flex', gap: 6, flexWrap: 'wrap' }}>
            {['React', 'TypeScript', 'Vite', 'Cloudflare Workers', 'MySQL', 'Drizzle', 'Docker'].map((tech) => (
        ...
        <div className="stat-card" style={{ gridColumn: '1 / -1' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: 14, marginTop: 8, lineHeight: 1.7, maxWidth: 700 }}>
