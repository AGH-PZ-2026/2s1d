/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=scripts/wrangler-typegen.env` (hash: 0ad23fa3c58eb1a374e83bec8f7214f9)
...
interface __BaseEnv_Env {
  ...
  INITIAL_ADMIN_EMAIL: '<YOUR_INITIAL_ADMIN_EMAIL>' | 'admin@agh.edu.pl';
...
declare namespace Cloudflare {
  ...
  interface ProductionEnv {
    ...
    AUTH_RATE_LIMITER: RateLimit;
    GOOGLE_CLIENT_ID: '<YOUR_GOOGLE_CLIENT_ID>';
    INITIAL_ADMIN_EMAIL: '<YOUR_INITIAL_ADMIN_EMAIL>';
    DEV_BYPASS_AUTH: string;
    JWT_SECRET: string;
  }
